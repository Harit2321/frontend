                ...
                <div className="glass-container fade-in" style={{
                    ...
                    <div className="text-center mb-4">
                        ...
                        <h1 style={{
                            ...
                            Welcome <em style={{ fontStyle: 'italic', color: 'var(--gold-lt)' }}>back</em>
                        </h1>
                        <p style={{
                            color: 'var(--muted)',
                            fontSize: '15px',
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.625rem' }}>
                                ...
                                <Link href="#" className="text-link" style={{ fontSize: '11px', textTransform: 'none', letterSpacing: '0.05em' }}>
                                    Forgot?
                                </Link>
                            </div>
                            <input
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem' }}>
                            ...
                            />
                            <label htmlFor="remember" style={{ color: 'var(--muted)', fontSize: '13px', cursor: 'pointer' }}>
